...
// ----------------------------------------------------------------------------
// ----------------------------------------------------------------------------
void singleDiffractive(Int_t nevents = 10, Int_t rngSeed = 1234){
    ...
    _primary->SetFileName("results/singleDiffractive.root");
    ...
    command("gkine -4 0");
    command("gfile o results/singleDiffractive.fzd");
