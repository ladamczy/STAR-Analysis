...
int main(int argc, char** argv){
    ...
    //deltaT with Starsim correction (identified signal)
    outsideprocessing.AddHistogram(TH1D("deltaT0StarsimCorrectedKpi", ";#Delta t_{K^{+}#pi^{-}} [ns];Number of pairs", 200, -10, 10));
    outsideprocessing.AddHistogram(TH1D("deltaT0StarsimCorrectedpiK", ";#Delta t_{K^{-}#pi^{+}} [ns];Number of pairs", 200, -10, 10));
    outsideprocessing.AddHistogram(TH1D("deltaT0StarsimCorrectedKK", ";#Delta t_{K^{+}K^{-}} [ns];Number of pairs", 200, -10, 10));
    ...
    outsideprocessing.AddHistogram(TH1D("MppiChi2BcgSimulated", ";m_{p^{+}#pi^{-}} [GeV/c^{2}];Number of pairs", 500, 1.0, 2.5));
    outsideprocessing.AddHistogram(TH1D("MpipChi2BcgSimulated", ";m_{p^{-}#pi^{+}} [GeV/c^{2}];Number of pairs", 500, 1.0, 2.5));
    outsideprocessing.AddHistogram(TH1D("MKKChi2BcgSimulated", ";m_{K^{+}K^{-}} [GeV/c^{2}];Number of pairs", 50, 0.99, 1.05));
    outsideprocessing.AddHistogram(TH1D("MpipiChi2BcgSimulated", ";m_{#pi^{+}#pi^{-}} [GeV/c^{2}];Number of pairs", 600, 0.2, 1.4));
    outsideprocessing.AddHistogram(TH1D("MppChi2BcgSimulated", ";m_{p^{+}p^{-}} [GeV/c^{2}];Number of pairs", 500, 1.5, 3.5));
                    ...
                    if(chi2Map["K_pi"]<9){
                        ...
                        if(getMother(tempUPCpointer, vector_MC_Track_positive[i], vector_MC_Track_negative[j])!=nullptr){
                            ...
                            if(motherName=="K*0"){
                                ...
                                insideprocessing.Fill("deltaT0StarsimCorrectedKpi", DeltaT0StarsimCorrected(vector_Track_positive[i], vector_Track_negative[j], particleMass[Kaon], particleMass[Pion]));
                            }
                        }
                        if(motherName!="K*0"){
                    ...
                    if(chi2Map["pi_K"]<9){
                        ...
                        if(getMother(tempUPCpointer, vector_MC_Track_positive[i], vector_MC_Track_negative[j])!=nullptr){
                            ...
                            if(motherName=="K*0_bar"){
                                ...
                                insideprocessing.Fill("deltaT0StarsimCorrectedpiK", DeltaT0StarsimCorrected(vector_Track_positive[i], vector_Track_negative[j], particleMass[Pion], particleMass[Kaon]));
                            }
                        }
                        if(motherName!="K*0_bar"){
                    ...
                    if(chi2Map["K_K"]<9){
                        ...
                        if(getMother(tempUPCpointer, vector_MC_Track_positive[i], vector_MC_Track_negative[j])!=nullptr){
                            ...
                            if(motherName=="phi"){
                                ...
                                insideprocessing.Fill("deltaT0StarsimCorrectedKK", DeltaT0StarsimCorrected(vector_Track_positive[i], vector_Track_negative[j], particleMass[Kaon], particleMass[Kaon]));
                            }
                        }
                        if(motherName!="phi"){
