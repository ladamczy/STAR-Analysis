...
int main(){
    ...
    REMOVING_DUPLICATES_K0_BEFORE->SetTitle(";m_{#pi^{+}#pi^{-}} [GeV/c^{2}];reconstructed K^{0}_{S}");
    REMOVING_DUPLICATES_K0_BEFORE->SetLineColor(kBlack);
    REMOVING_DUPLICATES_K0_BEFORE->Draw();
    REMOVING_DUPLICATES_K0_AFTER->SetTitle(";m_{#pi^{+}#pi^{-}} [GeV/c^{2}];reconstructed K^{0}_{S}");
    REMOVING_DUPLICATES_K0_AFTER->SetLineColor(kBlue);
    REMOVING_DUPLICATES_K0_AFTER->Draw("same");
    REMOVING_DUPLICATES_K0_DIFFERENCE->SetTitle(";m_{#pi^{+}#pi^{-}} [GeV/c^{2}];reconstructed K^{0}_{S}");
    ...
    REMOVING_DUPLICATES_Lambda0_BEFORE->SetTitle(";m_{#pi^{+}#pi^{-}} [GeV/c^{2}];reconstructed K^{0}_{S}");
    REMOVING_DUPLICATES_Lambda0_BEFORE->SetLineColor(kBlack);
    REMOVING_DUPLICATES_Lambda0_BEFORE->Draw();
    REMOVING_DUPLICATES_Lambda0_AFTER->SetTitle(";m_{#pi^{+}#pi^{-}} [GeV/c^{2}];reconstructed K^{0}_{S}");
    REMOVING_DUPLICATES_Lambda0_AFTER->SetLineColor(kBlue);
    REMOVING_DUPLICATES_Lambda0_AFTER->Draw("same");
    REMOVING_DUPLICATES_Lambda0_DIFFERENCE->SetTitle(";m_{#pi^{+}#pi^{-}} [GeV/c^{2}];reconstructed K^{0}_{S}");
