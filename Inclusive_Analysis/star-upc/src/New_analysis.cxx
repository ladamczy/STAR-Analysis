...
int main(int argc, char** argv) 
{
    ...
    for (int i = 0; i < 6; i++){
        ...
        string title = Hist_type[0] + ", " + ToF_no_pion[i/3] + ", " + ToF_pion[i%3] + ";inv. mass [GeV];events";
    ...
    for (int i = 0; i < 6; i++){
        ...
        string title = Hist_type[1] + ", " + ToF_no_pion[i/3] + ", " + ToF_pion[i%3] + ";inv. mass [GeV];vertices";
    ...
    for (int i = 0; i < 6; i++){
        ...
        string title = Hist_type[2] + ", " + ToF_no_pion[i/3] + ", " + ToF_pion[i%3] + ";#phi angle [rad];events";
    ...
    string outfileName = outputFolder + "AnaOutput_NewAnalysis.root";
