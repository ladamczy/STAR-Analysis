int Hist(){
    ...
    c1->SetGrid();
    gPad->SetLogy();
    TH1D *NotherTracks = (TH1D *)anaoutput1->Get("NotherTracks");
    ...
    TH2D *VertexMultiplicity = (TH2D *)anaoutput1->Get("VertexMultiplicity");
    c1->SetLogz();
    ...
    c1->SetGrid();
    gPad->SetLogy();
    TH1D *K0multiplicity = (TH1D *)anaoutput1->Get("K0multiplicity");
    ...
    c1->SetGrid();
    // gPad->SetLogy();
    TH1D *PVV0K0dist = (TH1D *)anaoutput1->Get("PVV0K0dist");
    ...
    c1->SetGrid();
    // gPad->SetLogy();
    TH1D *K0PVdistance = (TH1D *)anaoutput1->Get("K0PVdistance");
