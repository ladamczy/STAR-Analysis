...
int main(int argc, char** argv)  
{
    ...
    inputFileName="/data2/New_star_data_full/part1/"+run+"/"+run+".root";
    outputFileName="DataAfterPreselection/presel_"+run+".root";      
    outputHistFileName="DataAfterPreselection/hist_"+run+".root";      
...
//    const vector <int> triggerCEP = {570701, 570705, 570711};
    const vector <int> triggerCEP = {570703,590703};
    for (Long64_t i = 0; i < chain->GetEntries(); ++i) 
    {
		...
		if (numberOfTracksWest == 1 and numberOfTracksEast == 0 or numberOfTracksWest == 0 and numberOfTracksEast ==1)
		{
...
//        delete outputFile;
    ...
    // Save histograms
    TFile *histFile = TFile::Open(outputHistFileName.c_str(), "RECREATE");
